    ...
    return (
        <aside className="flex relative w-full h-full flex-col items-center max-sm:justify-center justify-start">
            ...
            <div className='flex relative max-sm:h-full h-[27rem] max-sm:w-full w-full max-sm:items-center items-end max-sm:justify-center max-md:justify-center justify-end max-sm:m-0 max-md:mb-2 mb-20'>
                <div className='flex items-center justify-center max-sm:h-[27rem] h-[26rem] w-full max-sm:mt-5'>
                    <img
                        ...
                        className='z-10 absolute max-sm:bottom-[2%] max-sm:right-auto max-lg:right-0 max-xl:right-0 bottom-0 max-sm:h-[10rem] max-lg:h-[16rem] h-[20rem] w-auto right-auto'
                        alt="imagem solida"
                    />
                    <img
                        src={ImageContactOutline}
                        className='z-30 absolute max-sm:bottom-[1%] max-sm:right-[8%] max-lg:right-0 max-xl:right-0 bottom-0 max-sm:h-[10rem] max-lg:h-[16rem] h-[20rem] w-auto right-auto'
                        alt="imagem outline"
                    />
                </div>
            </div>
            <div className='max-sm:hidden flex max-lg:flex-row flex-col max-md:h-10 h-12 w-full items-center max-md:justify-start justify-center max-md:mb-0 max-md:mt-6 max-md:ml-8 mb-20 max-md:pl-0 max-lg:pl-12'>
                <div className='flex max-lg:flex-row flex-col max-md:h-8 h-14 max-lg:w-full max-xl:w-auto w-1/2 border-l-2 border-button_and_icons max-lg:items-center max-xl:items-center items-start justify-between max-md:pl-2 pl-6 max-xl:mr-0 max-[1540px]:-mr-[11%] max-[1921px]:-mr-[19%]'>
